  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      if(swordGroup.isTouching(boy)) {
        ...
        // Oncethe game is done it will show the end image
        ...
        // command to destory the item once it is at gameover state
         cashG.destroyEach();
         diamondsG.destroyEach();
         jewelryG.destroyEach();
         swordGroup.destroyEach();
...
// instruction/ functions for the Cash
function createCash() {
...
// instruction/ functions for the Diamonds
...
// instruction/ functions for the Jewelry
...
// instruction/ functions for the Sword
